...
6. **Screenshot Zoom & Image Preview:**
   ...
   - Clicking any image/screenshot launches a high-fidelity full-screen overlay modal displaying the high-resolution image with a click-to-close action (backdrop blur, backdrop shade, fade/scale entrance transitions).
